...
def dilated_net(x, drop_probability, is_training):
    with tf.variable_scope('dilated_net'):
        ...
        with tf.variable_scope('dilated_block'):
            ...
            batch_dlt1 = tf.layers.batch_normalization(inputs=conv3, training=is_training, name='batch_c3')
            dilated1 = tf.layers.conv2d(inputs=batch_dlt1,
                                        filters=128, kernel_size=[3, 3], strides=[1, 1], padding='same',
                                        activation=tf.nn.relu, dilation_rate=(2, 2), name='dilated1')
            batch_dlt1 = tf.layers.batch_normalization(inputs=dilated1, training=is_training, name='batch_dlt1')
            """ dilated 32x32"""
            dilated2 = tf.layers.conv2d(inputs=tf.concat([pool2, batch_dlt1], axis=3),
                                        filters=128, kernel_size=[3, 3], strides=[1, 1], padding='same',
                                        activation=tf.nn.relu, dilation_rate=(2, 2), name='dilated2')
            batch_dlt2 = tf.layers.batch_normalization(inputs=dilated2, training=is_training, name='batch_dlt2')

            """ dilated 16x16"""
            dilated3 = tf.layers.conv2d(inputs=tf.concat([pool2, batch_dlt1, batch_dlt2], axis=3),
                                        filters=128, kernel_size=[3, 3], strides=[1, 1], padding='same',
                                        activation=tf.nn.relu, dilation_rate=(2, 2), name='dilated3')
            batch_dlt3 = tf.layers.batch_normalization(inputs=dilated3, training=is_training, name='batch_dlt3')

            """ dilated 8x8"""
            dilated4 = tf.layers.conv2d(inputs=tf.concat([pool2, batch_dlt1, batch_dlt2, batch_dlt3], axis=3),
                                        filters=128, kernel_size=[3, 3], strides=[1, 1], padding='same',
                                        activation=tf.nn.relu, dilation_rate=(2, 2), name='dilated4')
            batch_dlt4 = tf.layers.batch_normalization(inputs=dilated4, training=is_training, name='batch_dlt4')

            """ dilated 4x4"""
            dilated5 = tf.layers.conv2d(inputs=tf.concat([pool2, batch_dlt1, batch_dlt2, batch_dlt3,
                                                          batch_dlt4], axis=3),
                                        filters=128, kernel_size=[3, 3], strides=[1, 1], padding='same',
                                        activation=tf.nn.relu, dilation_rate=(2, 2), name='dilated5')
            batch_dlt5 = tf.layers.batch_normalization(inputs=dilated5, training=is_training, name='batch_dlt5')

            """ dilated 2x2"""
            dilated6 = tf.layers.conv2d(inputs=tf.concat([pool2, batch_dlt1, batch_dlt2, batch_dlt3,
                                                          batch_dlt4, batch_dlt5], axis=3),
                                        filters=128, kernel_size=[3, 3], strides=[1, 1], padding='same',
                                        activation=tf.nn.relu, dilation_rate=(2, 2), name='dilated6')
            batch_dlt6 = tf.layers.batch_normalization(inputs=dilated6, training=is_training, name='batch_dlt6')

            """ dilated 1x1"""
            dilated7 = tf.layers.conv2d(inputs=tf.concat([pool2, batch_dlt1, batch_dlt2, batch_dlt3,
                                                          batch_dlt4, batch_dlt5, batch_dlt6], axis=3),
                                        filters=128, kernel_size=[3, 3], strides=[1, 1], padding='same',
                                        activation=tf.nn.relu, dilation_rate=(1, 1), name='dilated7')
            batch_dlt7 = tf.layers.batch_normalization(inputs=dilated7, training=is_training, name='batch_dlt7')

            """ dilated 1x1"""
            dilated8 = tf.layers.conv2d(inputs=tf.concat([pool2, batch_dlt1, batch_dlt2, batch_dlt3,
                                                          batch_dlt4, batch_dlt5, batch_dlt6, batch_dlt7], axis=3),
                                        filters=128, kernel_size=[3, 3], strides=[1, 1], padding='same',
                                        activation=tf.nn.relu, dilation_rate=(2, 2), name='dilated8')
            batch_dlt8 = tf.layers.batch_normalization(inputs=dilated8, training=is_training, name='batch_dlt8')

            dilated_out = tf.concat([pool2, batch_dlt1, batch_dlt2, batch_dlt3, batch_dlt4,
                                     batch_dlt5, batch_dlt6, batch_dlt7, batch_dlt8], axis=3)
